...
impl Gpu {
    ...
    // ── Gemma 4 MoE GEMV dispatch (HFQ4G128, bucketed routing) ──
    ...
    /// Gemma 4 MoE gate_up MQ4G256/MG4G256 bucketed dispatch.
    /// Thin wrapper: MQ4 GEMV inner loop is byte-identical to HFQ4G256's
    /// (same 136 B groups); the only difference is the caller pre-rotates
    /// x via FWHT once before launch.
    #[allow(clippy::too_many_arguments)]
