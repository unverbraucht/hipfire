...
| 7 | Qwen2 dense (standalone) | `hipfire-arch-qwen2` | rev 0 skeleton; full bring-up in `docs/plans/qwen_2.5_vlm.md` phase 1 |
| 8 | Qwen2-VL family (dots.ocr) | `hipfire-arch-dots-ocr` | reserved; bring-up in `docs/plans/qwen_2.5_vlm.md` phase 2-3 |
