...
**Last updated:** 2026-05-15 PM (4B Stage B GPTQ data point landed §3.1: mq4-awq+gptq+Q8conv1d KLD 0.0662 / PPL 10.71 @ n=512 on gfx1151, coherent at greedy; first 4B quant on hipfire; VL-naming gotcha documented. Prior: F2 AWQ whitelist expansion + KLD/NLL methodology rule 9; mq4-kmd2-awq landed §1.1h: AWQ extension to K-map MQ6 tensors → −20.1% KLD vs kmd2 baseline at matched conditions; §1.1i F2 alpha-sweep reproduced on gfx1151: α=0.55 sweet spot is arch-portable, NLL paired-t = −8.48 vs gfx906's −8.65)
**Owner:** hipfire eval
