...
- **2026-05-14 — 0.8B shipping recipe: mq4-awq + Q8 conv1d.** KLD 0.1366 / PPL 19.61 at n=512 q8-KV prefill. −49% KLD vs base, −11% PPL vs base. No GPTQ, no kmd2 (which has its own gfx1100 dispatch issue). The current default to ship as "0.8B 4-bit" — both gates (KLD, PPL) agree.
